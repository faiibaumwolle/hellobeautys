...
$data = $product->queryproductnew(0,4);
?>
<div class="row">
    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-12" style="margin: 20px 0px 20px 0px;">
                    <ul class="bxslider">
                      <li><img src="images/banner1.jpg" style="width: 100%" alt="Responsive image" style=""></li>
                      <li><img src="images/banner2.jpg" style="width: 100%" alt="Responsive image" style=""></li>
                    </ul>
                <center>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <img src="images/popup/2-1.jpg" id="img-pop" class="img-responsive-width" width="580">
  ...
  'default': 'short'
    ...
    function chg(img){
        if(img == 1){
            ...
            $("#img-pop").prop("src", "images/popup/2-1.jpg");
        } else if (img == 2){
            $("#img-pop").prop("src", "images/popup/2-2.jpg");
            $("#bt-2").addClass("active");
            $("#bt-1").removeClass("active");
        } else if (img == 3){
            $("#img-pop").prop("src", "images/popup/2-3.jpg");
            $("#bt-2").addClass("active");
            $("#bt-1").removeClass("active");
        }
    }
