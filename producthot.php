...
$dataall = $product->queryproducthotall();
...
$start = ($p - 1) * $perpage;
$data = $product->queryproducthot($start,$perpage);
    ...
    <div class="row">
                    ...
                    <div class="row" style="background-color: #FDD7E4; width: 100%;">
                        <div class="col-md-12">
                            <table class="table" >
                                ...
                                <tr><td><a class="menu-left" href="index.php?page=producthot" style="color: #FF5675;">WHAT'S HOT</a></td></tr>
                            </table>
                        </div>
                    </div>
                    <br>
        ...
        <div class="col-md-9" style="margin-bottom: 30px;">
            ...
            <center><nav style="">
                <ul class="pagination">
                <li>
                    <a href="index.php?page=producthot&p=1" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <?php for($i=1;$i<=$total_page;$i++){ ?>
                <li>
                    <a href="index.php?page=producthot&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php } ?>
                <li>
                    <a href="index.php?page=producthot&p=<?php echo $total_page;?>" aria-label="Next">
