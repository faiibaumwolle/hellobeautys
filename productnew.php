...
$dataall = $product->queryproductnewall();
...
$start = ($p - 1) * $perpage;
$data = $product->queryproductnew($start,$perpage);
    ...
    <div class="row">
                    ...
                    <div class="row" style="background-color: #FDD7E4; width: 100%;">
                        <div class="col-md-12">
                            <table class="table" >
                                ...
                                <tr><td><a class="menu-left" href="index.php?page=product">PRODUCT</a></td></tr>
                                <tr><td><a class="menu-left" href="index.php?page=productnew" style="color: #FF5675;">NEW ARRIVALS</a></td></tr>
        ...
        <div class="col-md-9" style="margin-bottom: 30px;">
            ...
            <center><nav style="">
                <ul class="pagination">
                <li>
                    <a href="index.php?page=productnew&p=1" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <?php for($i=1;$i<=$total_page;$i++){ ?>
                <li>
                    <a href="index.php?page=productnew&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php } ?>
                <li>
                    <a href="index.php?page=productnew&p=<?php echo $total_page;?>" aria-label="Next">
