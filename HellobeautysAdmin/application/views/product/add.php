                    ...
                    <form action="<?=index_url()?>product_add" id="product_form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                      ...
                      <div class="form-group form-group-default required">
                        ...
                        <input type="text" name="discount_price" id="discount_price" class="form-control" required="">
                      </div>
                      <div class="form-group form-group-default required">
                      ...
                      <div class="form-group required">
                        <textarea rows="5" name="detail" class="form-control" id="name" placeholder="Detail" aria-invalid="false"></textarea>
                      </div>
