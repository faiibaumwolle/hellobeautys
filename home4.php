    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-12" style="margin: 20px 0px 20px 0px;">
                    <ul class="bxslider">
                      <li><img src="images/logo-head2.jpg" class="img-responsive"  alt="Responsive image" style=""></li>
                      <li><img src="images/logo-head.jpg" class="img-responsive"  alt="Responsive image" style=""></li>
                    </ul>
                <center>
