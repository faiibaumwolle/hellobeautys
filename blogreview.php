...
$start = ($p - 1) * $perpage;
$data = $blog->queryblog($start,$perpage);
        ...
        <div class="col-md-9">
            ...
            ?>
                    ...
                    <div class="col-md-6" style="margin: 10px 0px 10px 0px;">
                        ...
                        <div style="height: 300px; margin: 10px 0px 10px 0px;" class="frame">
                            <center><img src="<?=$image?>" class="img"></center>
                        </div>
                        <div style="height: 20px; color: #E77471; margin: 10px 0px 10px 0px; text-align: right;">
                            <a class="blog" href="index.php?page=blogreviewread&name=<?=$name?>"><b>อ่านต่อ...</b></a>
                        </div>
                    </div>
                    <?=(($i%2 != 0)?"</div>":"")?>
            <?php  }?>
            ...
            <center><nav style="">
                <ul class="pagination">
                <li>
                    <a href="index.php?page=blogreview&p=1" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <?php for($i=1;$i<=$total_page;$i++){ ?>
                <li>
                    <a href="index.php?page=blogreview&p=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php } ?>
                <li>
                    <a href="index.php?page=blogreview&p=<?php echo $total_page;?>" aria-label="Next">
