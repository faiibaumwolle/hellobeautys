...
$data = $blog->queryvideoByname($name);
?>
<div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row visible-lg visible-md">
                    <div class="col-md-12" style="margin: 10px 0px 10px 0px; text-align: justify;">
                        <div style="height: 100%; margin-top: 10px; color: #FF7493;">
                            <a class="blog" href="index.php?page=videoreviewread&id=<?=$name?>"><h5><b><?php echo $name; ?></b></h5></a>
                        </div>
                        <div style="height: 100%; margin-top: 10px; color: #FF7493;">
                           <iframe src="<?=$source?>" frameborder="0" width="640" height="360"></iframe>
                        </div>
                    </div>
            </div>
